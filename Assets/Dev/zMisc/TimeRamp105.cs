...
#pragma warning disable 414
    ...
    public bool smoothStep
    {
        ...
        set { if (value) curveShape = CurveShapes.smooth; else curveShape = CurveShapes.linear; }
    }
    public bool overshoot
    {
        get { return curveShape == CurveShapes.overshoot; }
        set { if (value) curveShape = CurveShapes.overshoot; else curveShape = CurveShapes.linear; }
    }
    ...
    float scaleValue(float f)
    {
        ...
        switch (curveShape)
        {
            ...
            case CurveShapes.linear: return f;
            case CurveShapes.smooth: return Mathf.SmoothStep(0, 1, f);
            case CurveShapes.overshoot: return overShootCurve(f);
        }
        return f;
    }
    public float value
    ...
    /// <summary>
    /// sets the callback Action to call when PageTransitioning from any state to REACHED ONE. use ClearCallbacks to clear both newFloatEvent
    /// </summary>
    ...
    /// <summary>
    /// sets the callback Action to call when PageTransitioning from any state to REACHED ZERO. use ClearCallbacks to clear both newFloatEvent
    /// </summary>
