...
public class UniversalTextShowEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        textShow.sourceValueType = (UniversalTextShow.SourceValueTypes)GUILayout.Toolbar((int)textShow.sourceValueType, System.Enum.GetNames(typeof(UniversalTextShow.SourceValueTypes)));
        ...
        if (textShow.targetGameObject != null)
        {
            ...
            for (int i = 0; i < componentNames.Length; i++)
            {
                ...
                if (components[i] != null)
                    ...
                    componentNames[i] = "invalid!";
            }
            int selectedComponentIndex2 = GUILayout.Toolbar(selectedComponentIndex, componentNames);
